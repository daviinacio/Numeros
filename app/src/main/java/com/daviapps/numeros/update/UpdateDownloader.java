		...
		new AlertDialog.Builder(this.context)
			...
			.setPositiveButton("Instalar", new DialogInterface.OnClickListener(){
				...
				public void onClick(DialogInterface p1, int p2){
					Toast.makeText(UpdateDownloader.this.context, "Caso não consiga instalar, desinstale a versão instalada e baixa a última versão em: https://bit.ly/android_numeros", Toast.LENGTH_LONG).show();
